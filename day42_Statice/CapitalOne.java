...
public class CapitalOne {
    public static void main(String[] args) {
       ...
       Developer[]developers={new Developer(),new Developer(),new Developer(),new Developer(),new Developer()};
        ...
        developers[3].setInfo("Verginia", 'F', 38962L, "Dev", 580000);
        developers[4].setInfo("Akbar", 'M', 43673L, "Dev", 620000);


        ScrumTeam team1=new ScrumTeam();
        team1.setInfo("Ramazan","Hamit","Ismat");
